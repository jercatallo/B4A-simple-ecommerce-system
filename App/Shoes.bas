...
Sub Activity_Create(FirstTime As Boolean)
	...
	txtprice.Text = 0
	TabHost1.AddTab("Heels","layheels.bal")
	TabHost1.AddTab("Wedges","laywedges.bal")
	TabHost1.AddTab("Loafers","layloafers.bal")
	ImageView1.Bitmap = LoadBitmap(File.DirAssets, "heels1.jpg")
	ImageView2.Bitmap = LoadBitmap(File.DirAssets, "heels2.jpg")
	ImageView3.Bitmap = LoadBitmap(File.DirAssets, "heels3.jpg")
	ImageView4.Bitmap = LoadBitmap(File.DirAssets, "wedges1.jpg")
	ImageView5.Bitmap = LoadBitmap(File.DirAssets, "wedges2.jpg")
	ImageView6.Bitmap = LoadBitmap(File.DirAssets, "wedges3.png")
	ImageView7.Bitmap = LoadBitmap(File.DirAssets, "loafers1.png")
	ImageView8.Bitmap = LoadBitmap(File.DirAssets, "loafers2.jpg")
	ImageView9.Bitmap = LoadBitmap(File.DirAssets, "loafers3.jpg")
End Sub
